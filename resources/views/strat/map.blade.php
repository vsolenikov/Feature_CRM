...
@section('content')
    ...
    <script src="https://api-maps.yandex.ru/2.1/?lang=ru_RU&apikey=52c3cdae-2c64-41df-ad15-dafc1b8a2411" type="text/javascript"></script>
...
<div class="container-fluid">
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <div class="c-state c-state--success">
                    <h3 class="c-state__title">Экология и безопасность <br></h3>
 ...
 <a href="/covid/map_eclg"><div class="btn_cat">Показать</div></a>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="c-state">
                    <h3 class="c-state__title">ЖКХ<br></h3>
 ...
 <a href="/covid/map_jkh"><div class="btn_cat">Показать</div></a>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="c-state c-state--success browntable">
                    <h3 class="c-state__title">Дороги и благосутройство<br></h3>
 ...
 <a href="/covid/map_ecnm"><div class="btn_cat">Показать</div></a>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="c-state c-state--danger">
                    <h3 class="c-state__title">Социальные объекты<br></h3>
 ...
 <a href="/covid/map_soc"><div class="btn_cat">Показать</div></a>
    ...
    <div class="col-xl-12">
        <div class="c-card u-p-medium u-mb-medium">
            <div class="u-flex u-justify-between u-align-items-center">
                ...
                <span class="u-text-small u-text-uppercase u-text-mute">в {{env('APP_REGION_NAME')? env('APP_REGION_NAME'):'Тутаевском районе'}}</span>
            </div>
            <div id="map"></div>
        </div>
    </div>
    <script>
        ymaps.ready(function () {
            ...
            //Аптеки, магазины, детские сады, предприятия
            /*
            * Координаты
            * Название учреждения
            * Режим работы
            ...
            * */
            @foreach($organisations as $organisation)
                var myPlacemark = new ymaps.Placemark([{{$organisation['cords']}}], {
                    balloonContentBody: [
'<address>',
