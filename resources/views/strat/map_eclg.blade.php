    ...
    <form>
        ...
        <script>
            ...
            ymaps.ready(function () {
                var myMap_eclg = new ymaps.Map('map', {
...
if('{{$organisation['type']}}'=="islands#blueGardenCircleIcon")
                {
                    var myPlacemark_eclg = new ymaps.Placemark([{{$organisation['cords']}}], {
                        balloonContentBody: [
                            '<address>',
                    ...
                    myMap_eclg.geoObjects.add(myPlacemark_eclg);
                }
                @endforeach
