    ...
    <form>
        ...
        <script>
            ...
            ymaps.ready(function () {
                var myMap_jkh = new ymaps.Map('map', {
                ...
                if('{{$organisation['type']}}'=="islands#blueMoneyCircleIcon") {
                    var myPlacemark_jkh = new ymaps.Placemark([{{$organisation['cords']}}], {
                        balloonContentBody: [
                            '<address>',
                    ...
                    myMap_jkh.geoObjects.add(myPlacemark_jkh);
                }
                @endforeach
